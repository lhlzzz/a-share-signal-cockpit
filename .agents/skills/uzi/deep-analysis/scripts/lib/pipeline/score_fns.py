...
- `generate_panel(dims_scored, raw)` · 65 评委已删除，返回空面板占位
...
def generate_panel(dims_scored: dict, raw: dict) -> dict:
    """65-judge panel removed. Keep the function so callers do not break."""
    return {
        ...
        "vote_distribution": {},
        "signal_distribution": {"bullish": 0, "neutral": 0, "bearish": 0, "skip": 0},
        "investors": [],
        "school_scores": {},
        "long_active": 0,
        "short_consensus": {},
