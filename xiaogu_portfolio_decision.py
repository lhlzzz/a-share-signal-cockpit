...
def _paper_observation(
    ...
    *,
    ...
    return {
        ...
        "event_time": snapshot.get("source_time") or snapshot.get("signal_time"),
        "available_at": snapshot.get("available_at") or snapshot.get("source_time"),
        "knowledge_available_at": snapshot.get("available_at") or snapshot.get("source_time"),
